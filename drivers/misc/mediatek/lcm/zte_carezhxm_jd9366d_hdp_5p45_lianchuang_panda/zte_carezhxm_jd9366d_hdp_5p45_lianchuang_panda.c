...
{
	LCM_LOGI("%s: kernel----zte_carezhxm_jd9366d_hdp_5p45_lianchuang_panda_drv----\n", __func__);
	lcm_init();
}
...
struct LCM_DRIVER zte_carezhxm_jd9366d_hdp_5p45_lianchuang_panda_lcm_drv = {
	.name = "zte_carezhxm_jd9366d_hdp_5p45_lianchuang_panda_drv",
