...
{
	LCM_LOGI("%s: kernel ----zte_monkeyxm_ft8006p_720p_6p_lcetron_drv----\n", __func__);
...
struct LCM_DRIVER zte_monkeyxm_ft8006p_720p_6p_lcetron_lcm_drv = {
	.name = "zte_monkeyxm_ft8006p_720p_6p_lcetron_drv",
