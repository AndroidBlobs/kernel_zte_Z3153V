...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
		#if defined(ZTE_OV16885_062_A7S)
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_1,
		#if defined(ZTE_SP2509_094_A7S_NONE)
		{
			{IMGSENSOR_HW_ID_MCLK, IMGSENSOR_HW_PIN_MCLK},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
...
#if defined(ZTE_OV16885_062_A7S)
	{
		SENSOR_DRVNAME_ZTE_OV16885_062_A7S,
		{
			{PDN,        Vol_Low,  0},
			{RST,        Vol_Low,  0},
			{DOVDD,      Vol_1800, 0},
...
#endif
#if defined(ZTE_GC5025_094_A7S)
	{SENSOR_DRVNAME_ZTE_GC5025_094_A7S,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(ZTE_HI846_134_A7S)
		{
			SENSOR_DRVNAME_ZTE_HI846_134_A7S,
			{
				{AVDD, Vol_2800, 0},
				{DVDD, Vol_1200, 0},
				{DOVDD, Vol_1800, 0},
...
#if defined(ZTE_SP2509_094_A7S)
	{
		SENSOR_DRVNAME_ZTE_SP2509_094_A7S,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
