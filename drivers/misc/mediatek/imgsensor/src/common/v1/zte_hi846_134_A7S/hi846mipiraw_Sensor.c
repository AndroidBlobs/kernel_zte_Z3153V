...
#define HI846_RG_Ratio_Typical   0x110
#define HI846_BG_Ratio_Typical   0x11a

//extern struct mutex HI846_OTP_MUTEX;
...
{
#if MULTI_WRITE
	LOG_INF("sensor_init : MULTI_WRITE activated. ");
	...
	hi846_table_write_cmos_sensor(
		...
		sizeof(kal_uint16));
#else
    LOG_INF("sensor_init : None MULTI_WRITE activated. ");
...
#endif
	LOG_INF("E: PLATFORM:MT6761,MIPI 4LANE\n");
